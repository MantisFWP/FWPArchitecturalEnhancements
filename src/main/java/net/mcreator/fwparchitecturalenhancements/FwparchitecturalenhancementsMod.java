...
public class FwparchitecturalenhancementsMod {
	...
	@SidedProxy(clientSide = "net.mcreator.fwparchitecturalenhancements.ClientProxyFwparchitecturalenhancementsMod", serverSide = "net.mcreator.fwparchitecturalenhancements.ServerProxyFwparchitecturalenhancementsMod")
	public static IProxyFwparchitecturalenhancementsMod proxy;
	@Mod.Instance(MODID)
	public static FwparchitecturalenhancementsMod instance;
	public ElementsFwparchitecturalenhancementsMod elements = new ElementsFwparchitecturalenhancementsMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsFwparchitecturalenhancementsMod.GuiHandler());

...
public class BlockBasicCyanGlassTinted extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:basic_cyan_glass_tinted")
	public static final Block block = null;
	public BlockBasicCyanGlassTinted(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 836);
	}

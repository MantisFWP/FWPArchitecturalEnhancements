...
public class BlockBasicRedGlassTinted extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:basic_red_glass_tinted")
	public static final Block block = null;
	public BlockBasicRedGlassTinted(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 839);
	}

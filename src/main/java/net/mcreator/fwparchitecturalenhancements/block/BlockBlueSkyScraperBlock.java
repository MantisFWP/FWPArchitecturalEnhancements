...
public class BlockBlueSkyScraperBlock extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:blue_sky_scraper_block")
	public static final Block block = null;
	public BlockBlueSkyScraperBlock(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 842);
	}

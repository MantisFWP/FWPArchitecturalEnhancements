...
public class BlockBrickMango extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:brickmango")
	public static final Block block = null;
	public BlockBrickMango(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 255);
	}

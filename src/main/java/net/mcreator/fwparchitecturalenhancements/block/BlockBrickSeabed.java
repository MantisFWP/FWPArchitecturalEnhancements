...
public class BlockBrickSeabed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:brickseabed")
	public static final Block block = null;
	public BlockBrickSeabed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 257);
	}

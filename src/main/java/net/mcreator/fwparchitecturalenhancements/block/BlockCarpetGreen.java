...
public class BlockCarpetGreen extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:carpetgreen")
	public static final Block block = null;
	public BlockCarpetGreen(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 329);
	}

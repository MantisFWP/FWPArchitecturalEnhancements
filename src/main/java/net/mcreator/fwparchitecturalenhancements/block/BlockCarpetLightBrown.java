...
public class BlockCarpetLightBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:carpetlightbrown")
	public static final Block block = null;
	public BlockCarpetLightBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 331);
	}

...
public class BlockCarpetRed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:carpetred")
	public static final Block block = null;
	public BlockCarpetRed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 333);
	}

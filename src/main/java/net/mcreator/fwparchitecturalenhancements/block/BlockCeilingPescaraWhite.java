...
public class BlockCeilingPescaraWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:ceilingpescarawhite")
	public static final Block block = null;
	public BlockCeilingPescaraWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 313);
	}

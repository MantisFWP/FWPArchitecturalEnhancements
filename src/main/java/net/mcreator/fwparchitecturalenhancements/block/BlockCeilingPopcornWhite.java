...
public class BlockCeilingPopcornWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:ceilingpopcornwhite")
	public static final Block block = null;
	public BlockCeilingPopcornWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 296);
	}

...
public class BlockClankwayTile extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:clankwaytile")
	public static final Block block = null;
	public BlockClankwayTile(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 424);
	}

...
public class BlockCommercialTilePurple extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:commercial_tile_purple")
	public static final Block block = null;
	public BlockCommercialTilePurple(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 808);
	}

...
public class BlockConcreteStainedBlue extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:concretestainedblue")
	public static final Block block = null;
	public BlockConcreteStainedBlue(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 484);
	}

...
public class BlockConcreteStainedLightGray extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:concretestainedlightgray")
	public static final Block block = null;
	public BlockConcreteStainedLightGray(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 479);
	}

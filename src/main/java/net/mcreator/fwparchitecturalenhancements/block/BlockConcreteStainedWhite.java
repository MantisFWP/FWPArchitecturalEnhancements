...
public class BlockConcreteStainedWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:concretestainedwhite")
	public static final Block block = null;
	public BlockConcreteStainedWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 478);
	}

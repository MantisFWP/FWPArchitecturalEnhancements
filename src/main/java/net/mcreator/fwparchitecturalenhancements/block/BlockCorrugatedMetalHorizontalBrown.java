...
public class BlockCorrugatedMetalHorizontalBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_horizontal_brown")
	public static final Block block = null;
	public BlockCorrugatedMetalHorizontalBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 510);
	}

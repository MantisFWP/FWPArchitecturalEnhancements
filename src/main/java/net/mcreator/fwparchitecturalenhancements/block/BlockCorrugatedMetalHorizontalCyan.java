...
public class BlockCorrugatedMetalHorizontalCyan extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_horizontal_cyan")
	public static final Block block = null;
	public BlockCorrugatedMetalHorizontalCyan(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 505);
	}

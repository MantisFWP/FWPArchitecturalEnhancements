...
public class BlockCorrugatedMetalHorizontalGreen extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_horizontal_green")
	public static final Block block = null;
	public BlockCorrugatedMetalHorizontalGreen(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 504);
	}

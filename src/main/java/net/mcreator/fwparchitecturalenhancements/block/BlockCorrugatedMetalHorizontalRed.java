...
public class BlockCorrugatedMetalHorizontalRed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_horizontal_red")
	public static final Block block = null;
	public BlockCorrugatedMetalHorizontalRed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 502);
	}

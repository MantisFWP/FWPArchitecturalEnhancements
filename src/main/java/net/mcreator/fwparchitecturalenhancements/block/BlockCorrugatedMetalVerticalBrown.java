...
public class BlockCorrugatedMetalVerticalBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_vertical_brown")
	public static final Block block = null;
	public BlockCorrugatedMetalVerticalBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 520);
	}

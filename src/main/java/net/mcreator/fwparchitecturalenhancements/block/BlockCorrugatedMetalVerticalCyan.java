...
public class BlockCorrugatedMetalVerticalCyan extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:corrugated_metal_vertical_cyan")
	public static final Block block = null;
	public BlockCorrugatedMetalVerticalCyan(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 515);
	}

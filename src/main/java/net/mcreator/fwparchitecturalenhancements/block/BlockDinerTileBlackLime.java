...
public class BlockDinerTileBlackLime extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:diner_tile_black_lime")
	public static final Block block = null;
	public BlockDinerTileBlackLime(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 590);
	}

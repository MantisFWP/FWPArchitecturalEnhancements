...
public class BlockDinerTileWhiteRed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:diner_tile_white_red")
	public static final Block block = null;
	public BlockDinerTileWhiteRed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 577);
	}

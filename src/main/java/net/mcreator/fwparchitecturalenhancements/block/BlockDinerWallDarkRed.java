...
public class BlockDinerWallDarkRed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:diner_wall_dark_red")
	public static final Block block = null;
	public BlockDinerWallDarkRed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 600);
	}

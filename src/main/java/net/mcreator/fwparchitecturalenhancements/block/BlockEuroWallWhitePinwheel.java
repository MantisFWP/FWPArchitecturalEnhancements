...
public class BlockEuroWallWhitePinwheel extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:euro_wall_white_pinwheel")
	public static final Block block = null;
	public BlockEuroWallWhitePinwheel(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 790);
	}

...
public class BlockEuroWallWhitePlus extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:euro_wall_white_plus")
	public static final Block block = null;
	public BlockEuroWallWhitePlus(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 791);
	}

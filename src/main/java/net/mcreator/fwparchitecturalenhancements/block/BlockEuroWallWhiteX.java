...
public class BlockEuroWallWhiteX extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:euro_wall_white_x")
	public static final Block block = null;
	public BlockEuroWallWhiteX(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 793);
	}

...
public class BlockGenericLightSlab extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:generic_light_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:generic_light_slab_double")
	public static final Block block_slab_double = null;
	public BlockGenericLightSlab(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 850);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("generic_light_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("generic_light_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fwparchitecturalenhancements:generic_light_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("generic_light_slab");

...
public class BlockGrainwayTile extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:grainwaytile")
	public static final Block block = null;
	public BlockGrainwayTile(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 419);
	}

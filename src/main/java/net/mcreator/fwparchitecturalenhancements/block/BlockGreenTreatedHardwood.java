...
public class BlockGreenTreatedHardwood extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:green_treated_hardwood")
	public static final Block block = null;
	public BlockGreenTreatedHardwood(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 663);
	}

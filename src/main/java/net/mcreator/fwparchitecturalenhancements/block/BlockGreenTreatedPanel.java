...
public class BlockGreenTreatedPanel extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:green_treated_panel")
	public static final Block block = null;
	public BlockGreenTreatedPanel(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 664);
	}

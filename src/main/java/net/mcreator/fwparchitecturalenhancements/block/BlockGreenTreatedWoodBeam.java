...
public class BlockGreenTreatedWoodBeam extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:green_treated_wood_beam")
	public static final Block block = null;
	public BlockGreenTreatedWoodBeam(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 665);
	}

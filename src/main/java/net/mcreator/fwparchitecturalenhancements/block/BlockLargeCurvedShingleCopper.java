...
public class BlockLargeCurvedShingleCopper extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:large_curved_shingle_copper")
	public static final Block block = null;
	public BlockLargeCurvedShingleCopper(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 745);
	}

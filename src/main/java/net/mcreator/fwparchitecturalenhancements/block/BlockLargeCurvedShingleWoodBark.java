...
public class BlockLargeCurvedShingleWoodBark extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:large_curved_shingle_wood_bark")
	public static final Block block = null;
	public BlockLargeCurvedShingleWoodBark(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 744);
	}

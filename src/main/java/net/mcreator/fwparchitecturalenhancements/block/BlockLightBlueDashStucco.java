...
public class BlockLightBlueDashStucco extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:light_blue_dash_stucco")
	public static final Block block = null;
	public BlockLightBlueDashStucco(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 861);
	}

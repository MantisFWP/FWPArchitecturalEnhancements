...
public class BlockLightBluePoolWater extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:light_blue_pool_water")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("light_blue_pool_water").setRegistryName("light_blue_pool_water"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName("light_blue_pool_water"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("fwparchitecturalenhancements:light_blue_pool_water", "light_blue_pool_water");
			}
		});

...
public class BlockLightPurplePoolWater extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:light_purple_pool_water")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:light_purple_pool_water")
	public static final Item item = null;
	private Fluid fluid;
	public BlockLightPurplePoolWater(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 801);

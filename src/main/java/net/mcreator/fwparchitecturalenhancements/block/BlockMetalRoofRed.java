...
public class BlockMetalRoofRed extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:metal_roof_red")
	public static final Block block = null;
	public BlockMetalRoofRed(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 545);
	}

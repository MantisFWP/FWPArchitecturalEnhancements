...
public class BlockMontwayTile extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:montwaytile")
	public static final Block block = null;
	public BlockMontwayTile(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 418);
	}

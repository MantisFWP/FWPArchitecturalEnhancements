...
public class BlockNewYearsPaperSip extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:new_years_paper_sip")
	public static final Block block = null;
	public BlockNewYearsPaperSip(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 877);
	}

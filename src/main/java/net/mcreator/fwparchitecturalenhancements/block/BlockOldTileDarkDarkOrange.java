...
public class BlockOldTileDarkDarkOrange extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:old_tile_dark_dark_orange")
	public static final Block block = null;
	public BlockOldTileDarkDarkOrange(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 738);
	}

...
public class BlockOldTileLighterDarkBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:old_tile_lighter_dark_brown")
	public static final Block block = null;
	public BlockOldTileLighterDarkBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 739);
	}

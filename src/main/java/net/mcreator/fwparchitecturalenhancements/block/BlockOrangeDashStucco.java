...
public class BlockOrangeDashStucco extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:orange_dash_stucco")
	public static final Block block = null;
	public BlockOrangeDashStucco(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 865);
	}

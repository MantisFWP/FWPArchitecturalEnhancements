...
public class BlockPaperWallBlankTopBottom extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:paper_wall_blank_top_bottom")
	public static final Block block = null;
	public BlockPaperWallBlankTopBottom(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 718);
	}

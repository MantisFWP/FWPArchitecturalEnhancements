...
public class BlockPaperWallRedDragon extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:paper_wall_red_dragon")
	public static final Block block = null;
	public BlockPaperWallRedDragon(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 722);
	}

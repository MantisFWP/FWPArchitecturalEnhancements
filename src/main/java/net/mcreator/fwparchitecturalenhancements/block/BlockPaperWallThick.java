...
public class BlockPaperWallThick extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:paper_wall_thick")
	public static final Block block = null;
	public BlockPaperWallThick(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 723);
	}

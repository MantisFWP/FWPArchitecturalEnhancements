...
public class BlockPhoenixBrickDarkGrey extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:phoenix_brick_dark_grey")
	public static final Block block = null;
	public BlockPhoenixBrickDarkGrey(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 649);
	}

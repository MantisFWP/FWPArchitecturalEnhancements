...
public class BlockPhoenixPath15 extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:phoenix_path_15")
	public static final Block block = null;
	public BlockPhoenixPath15(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 769);
	}

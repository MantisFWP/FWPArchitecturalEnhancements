...
public class BlockPhoenixPath4 extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:phoenix_path_4")
	public static final Block block = null;
	public BlockPhoenixPath4(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 758);
	}

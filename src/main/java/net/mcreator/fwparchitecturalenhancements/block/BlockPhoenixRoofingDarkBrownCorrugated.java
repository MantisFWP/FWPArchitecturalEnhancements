...
public class BlockPhoenixRoofingDarkBrownCorrugated extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:phoenix_roofing_dark_brown_corrugated")
	public static final Block block = null;
	public BlockPhoenixRoofingDarkBrownCorrugated(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 677);
	}

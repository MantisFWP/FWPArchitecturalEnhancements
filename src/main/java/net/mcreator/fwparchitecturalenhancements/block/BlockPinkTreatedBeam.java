...
public class BlockPinkTreatedBeam extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:pink_treated_beam")
	public static final Block block = null;
	public BlockPinkTreatedBeam(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 668);
	}

...
public class BlockPoolAqua extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:pool_aqua")
	public static final Block block = null;
	public BlockPoolAqua(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 653);
	}

...
public class BlockPoolBlue extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:pool_blue")
	public static final Block block = null;
	public BlockPoolBlue(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 654);
	}

...
public class BlockPoolVeryLightGray extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:pool_very_light_gray")
	public static final Block block = null;
	public BlockPoolVeryLightGray(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 659);
	}

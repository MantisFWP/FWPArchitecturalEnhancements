...
public class BlockRandomRainbowBrick extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:randomrainbowbrick")
	public static final Block block = null;
	public BlockRandomRainbowBrick(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 220);
	}

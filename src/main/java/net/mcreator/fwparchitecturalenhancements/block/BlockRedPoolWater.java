...
public class BlockRedPoolWater extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:red_pool_water")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:red_pool_water")
	public static final Item item = null;
	private Fluid fluid;
	public BlockRedPoolWater(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 802);

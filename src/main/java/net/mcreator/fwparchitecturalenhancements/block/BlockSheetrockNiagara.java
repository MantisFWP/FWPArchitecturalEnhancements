...
public class BlockSheetrockNiagara extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sheetrockniagara")
	public static final Block block = null;
	public BlockSheetrockNiagara(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 68);
	}

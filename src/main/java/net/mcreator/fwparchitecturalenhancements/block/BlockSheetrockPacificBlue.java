...
public class BlockSheetrockPacificBlue extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sheetrockpacificblue")
	public static final Block block = null;
	public BlockSheetrockPacificBlue(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 77);
	}

...
public class BlockSheetrockPaleSky extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sheetrockpalesky")
	public static final Block block = null;
	public BlockSheetrockPaleSky(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 14);
	}

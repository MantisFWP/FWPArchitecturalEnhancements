...
public class BlockSheetrockVenusTrimT extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sheetrockvenustrimt")
	public static final Block block = null;
	public BlockSheetrockVenusTrimT(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 42);
	}

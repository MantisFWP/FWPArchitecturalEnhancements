...
public class BlockShingleGreen extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:shinglegreen")
	public static final Block block = null;
	public BlockShingleGreen(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 278);
	}

...
public class BlockShutterPurple extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:shutter_purple")
	public static final Block block = null;
	public BlockShutterPurple(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 562);
	}

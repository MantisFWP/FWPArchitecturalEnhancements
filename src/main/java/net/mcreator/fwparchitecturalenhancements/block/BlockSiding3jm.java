...
public class BlockSiding3jm extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding3jm")
	public static final Block block = null;
	public BlockSiding3jm(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 131);
	}

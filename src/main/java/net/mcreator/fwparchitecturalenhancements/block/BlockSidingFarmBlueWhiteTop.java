...
public class BlockSidingFarmBlueWhiteTop extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_farm_blue_white_top")
	public static final Block block = null;
	public BlockSidingFarmBlueWhiteTop(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 644);
	}

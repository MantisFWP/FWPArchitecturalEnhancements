...
public class BlockSidingFarmWhiteBottom extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sidingfarmwhitebottom")
	public static final Block block = null;
	public BlockSidingFarmWhiteBottom(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 500);
	}

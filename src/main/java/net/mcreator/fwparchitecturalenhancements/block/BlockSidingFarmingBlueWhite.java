...
public class BlockSidingFarmingBlueWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_farming_blue_white")
	public static final Block block = null;
	public BlockSidingFarmingBlueWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 643);
	}

...
public class BlockSidingLargeBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_large_brown")
	public static final Block block = null;
	public BlockSidingLargeBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 617);
	}

...
public class BlockSidingLargeGrey extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_large_grey")
	public static final Block block = null;
	public BlockSidingLargeGrey(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 621);
	}

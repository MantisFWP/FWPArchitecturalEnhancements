...
public class BlockSidingLargeTan extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_large_tan")
	public static final Block block = null;
	public BlockSidingLargeTan(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 626);
	}

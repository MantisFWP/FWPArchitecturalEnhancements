...
public class BlockSidingOrangeTrimW extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sidingorangetrimw")
	public static final Block block = null;
	public BlockSidingOrangeTrimW(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 198);
	}

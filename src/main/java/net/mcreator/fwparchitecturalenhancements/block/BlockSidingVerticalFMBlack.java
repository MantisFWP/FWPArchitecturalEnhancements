...
public class BlockSidingVerticalFMBlack extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_vertical_fm_black")
	public static final Block block = null;
	public BlockSidingVerticalFMBlack(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 631);
	}

...
public class BlockSidingVerticalLightBlue extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_vertical_light_blue")
	public static final Block block = null;
	public BlockSidingVerticalLightBlue(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 634);
	}

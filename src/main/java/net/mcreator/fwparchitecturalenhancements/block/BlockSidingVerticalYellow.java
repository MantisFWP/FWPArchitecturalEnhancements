...
public class BlockSidingVerticalYellow extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:siding_vertical_yellow")
	public static final Block block = null;
	public BlockSidingVerticalYellow(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 639);
	}

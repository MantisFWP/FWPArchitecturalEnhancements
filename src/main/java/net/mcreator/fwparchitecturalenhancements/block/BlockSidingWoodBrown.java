...
public class BlockSidingWoodBrown extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sidingwoodbrown")
	public static final Block block = null;
	public BlockSidingWoodBrown(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 427);
	}

...
public class BlockSidingWoodFMBlack extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:sidingwoodfmblack")
	public static final Block block = null;
	public BlockSidingWoodFMBlack(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 430);
	}

...
public class BlockSmallCurvedShinglePinecone extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:small_curved_shingle_pinecone")
	public static final Block block = null;
	public BlockSmallCurvedShinglePinecone(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 749);
	}

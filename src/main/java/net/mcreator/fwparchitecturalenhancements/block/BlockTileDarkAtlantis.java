...
public class BlockTileDarkAtlantis extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tiledarkatlantis")
	public static final Block block = null;
	public BlockTileDarkAtlantis(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 394);
	}

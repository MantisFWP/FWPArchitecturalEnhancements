...
public class BlockTileDarkViridian extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tiledarkviridian")
	public static final Block block = null;
	public BlockTileDarkViridian(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 377);
	}

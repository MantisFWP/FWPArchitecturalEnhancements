...
public class BlockTileLightEmerald extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tilelightemerald")
	public static final Block block = null;
	public BlockTileLightEmerald(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 357);
	}

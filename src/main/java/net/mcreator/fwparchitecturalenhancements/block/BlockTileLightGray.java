...
public class BlockTileLightGray extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tilelightgray")
	public static final Block block = null;
	public BlockTileLightGray(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 366);
	}

...
public class BlockTileLightViridian extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tilelightviridian")
	public static final Block block = null;
	public BlockTileLightViridian(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 372);
	}

...
public class BlockTileLightWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:tilelightwhite")
	public static final Block block = null;
	public BlockTileLightWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 351);
	}

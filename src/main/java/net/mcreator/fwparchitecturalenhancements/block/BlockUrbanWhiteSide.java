...
public class BlockUrbanWhiteSide extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:urban_white_side")
	public static final Block block = null;
	public BlockUrbanWhiteSide(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 828);
	}

...
public class BlockVinylCheckeredLavendar extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:vinylcheckeredlavendar")
	public static final Block block = null;
	public BlockVinylCheckeredLavendar(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 470);
	}

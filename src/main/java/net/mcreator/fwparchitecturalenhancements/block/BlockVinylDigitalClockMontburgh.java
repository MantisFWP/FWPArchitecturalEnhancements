...
public class BlockVinylDigitalClockMontburgh extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:vinyldigitalclockmontburgh")
	public static final Block block = null;
	public BlockVinylDigitalClockMontburgh(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 444);
	}

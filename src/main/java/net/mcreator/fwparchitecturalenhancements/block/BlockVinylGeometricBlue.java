...
public class BlockVinylGeometricBlue extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:vinylgeometricblue")
	public static final Block block = null;
	public BlockVinylGeometricBlue(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 452);
	}

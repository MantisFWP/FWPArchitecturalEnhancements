...
public class BlockWallpaperBamboo extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wallpaper_bamboo")
	public static final Block block = null;
	public BlockWallpaperBamboo(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 602);
	}

...
public class BlockWallpaperFujiTop extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wallpaper_fuji_top")
	public static final Block block = null;
	public BlockWallpaperFujiTop(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 604);
	}

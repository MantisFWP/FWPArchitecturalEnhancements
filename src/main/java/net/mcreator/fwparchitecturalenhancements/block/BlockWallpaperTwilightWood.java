...
public class BlockWallpaperTwilightWood extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wallpaper_twilight_wood")
	public static final Block block = null;
	public BlockWallpaperTwilightWood(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 610);
	}

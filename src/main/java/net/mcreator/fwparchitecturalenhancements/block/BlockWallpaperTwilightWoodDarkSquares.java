...
public class BlockWallpaperTwilightWoodDarkSquares extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wallpaper_twilight_wood_dark_squares")
	public static final Block block = null;
	public BlockWallpaperTwilightWoodDarkSquares(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 611);
	}

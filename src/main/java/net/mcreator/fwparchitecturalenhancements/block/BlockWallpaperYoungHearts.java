...
public class BlockWallpaperYoungHearts extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wallpaper_young_hearts")
	public static final Block block = null;
	public BlockWallpaperYoungHearts(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 614);
	}

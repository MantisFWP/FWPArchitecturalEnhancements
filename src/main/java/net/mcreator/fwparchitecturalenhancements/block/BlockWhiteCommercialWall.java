...
public class BlockWhiteCommercialWall extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:white_commercial_wall")
	public static final Block block = null;
	public BlockWhiteCommercialWall(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 818);
	}

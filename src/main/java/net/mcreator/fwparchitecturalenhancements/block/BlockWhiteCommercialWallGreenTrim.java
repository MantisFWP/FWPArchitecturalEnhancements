...
public class BlockWhiteCommercialWallGreenTrim extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:white_commercial_wall_green_trim")
	public static final Block block = null;
	public BlockWhiteCommercialWallGreenTrim(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 821);
	}

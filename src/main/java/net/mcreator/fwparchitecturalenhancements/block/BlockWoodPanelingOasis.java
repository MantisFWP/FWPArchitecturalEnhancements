...
public class BlockWoodPanelingOasis extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wood_paneling_oasis")
	public static final Block block = null;
	public BlockWoodPanelingOasis(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 538);
	}

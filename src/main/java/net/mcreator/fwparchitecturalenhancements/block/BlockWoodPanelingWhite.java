...
public class BlockWoodPanelingWhite extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wood_paneling_white")
	public static final Block block = null;
	public BlockWoodPanelingWhite(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 521);
	}

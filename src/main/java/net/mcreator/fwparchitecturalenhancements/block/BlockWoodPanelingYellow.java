...
public class BlockWoodPanelingYellow extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:wood_paneling_yellow")
	public static final Block block = null;
	public BlockWoodPanelingYellow(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 522);
	}

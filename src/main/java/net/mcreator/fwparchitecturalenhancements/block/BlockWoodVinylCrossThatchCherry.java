...
public class BlockWoodVinylCrossThatchCherry extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:woodvinylcrossthatchcherry")
	public static final Block block = null;
	public BlockWoodVinylCrossThatchCherry(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 441);
	}

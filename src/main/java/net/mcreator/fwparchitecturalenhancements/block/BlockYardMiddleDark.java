...
public class BlockYardMiddleDark extends ElementsFwparchitecturalenhancementsMod.ModElement {
	@GameRegistry.ObjectHolder("fwparchitecturalenhancements:yard_middle_dark")
	public static final Block block = null;
	public BlockYardMiddleDark(ElementsFwparchitecturalenhancementsMod instance) {
		super(instance, 732);
	}
